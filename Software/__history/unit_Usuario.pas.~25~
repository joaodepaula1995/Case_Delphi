...
begin
  if txt_coduser.Text <= '0' then
    ...
    begin
      try
        FRM_MENSAGEM_CONFIRMACAO.lbl_mensagem.Caption := 'Deseja realmente deletar o Usuário?';
